...
def run_comparison_demo(data_file: str, symbol: str = 'BTCUSD'):
    ...
    print()
    print("Next steps:")
    print("1. Review database file: backtest_results.db")
    print("2. Run more backtests with different strategies")
    print("3. Experiment with different cost models")
    print("4. Move on to Phase 2: Parameter Optimization")
    print()
